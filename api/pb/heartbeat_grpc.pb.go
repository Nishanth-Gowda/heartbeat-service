...
const (
	Monitor_SendHeartbeat_FullMethodName = "/heartbeat.Monitor/SendHeartbeat"
)
...
func (c *monitorClient) SendHeartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*HeartbeatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HeartbeatResponse)
	err := c.cc.Invoke(ctx, Monitor_SendHeartbeat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMonitorServer) SendHeartbeat(context.Context, *HeartbeatRequest) (*HeartbeatResponse, error) {
...
func _Monitor_SendHeartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HeartbeatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MonitorServer).SendHeartbeat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Monitor_SendHeartbeat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MonitorServer).SendHeartbeat(ctx, req.(*HeartbeatRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Monitor_SendHeartbeat_Handler,
		},
	},
